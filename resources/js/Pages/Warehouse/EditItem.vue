                    ...
                    <form @submit.prevent="submit" class="p-6 space-y-6">
                        ...
                        <div class="flex justify-end space-x-3">
                            ...
                            >
                                ...
                                {{ processing ? 'Salvataggio...' : 'Aggiorna Articolo' }}
                            </button>
                        </div>
                    </form>
                </div>
...
export default {
    ...
    setup(props) {
        const form = useForm({
            ...
            warranty_expiry: props.item.warranty_expiry || '',
    ...
    methods: {
        submit() {
            ...
            this.form.patch(route('warehouse.items.update', this.item.id), {
                onSuccess: () => {
