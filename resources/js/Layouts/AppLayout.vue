                    ...
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <template v-if="$page.props.auth.user">
                                <!-- Dropdown Magazzino -->
                                <div class="relative inline-flex items-center" @mouseenter="showWarehouseMenu = true" @mouseleave="showWarehouseMenu = false">
                                    <Link :href="route('warehouse.index')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none" 
                                            :class="route().current('warehouse.*') ? 'border-indigo-400 text-gray-900 focus:border-indigo-700' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:text-gray-700 focus:border-gray-300'">
                                        Magazzino
                                    ...
                                    <!-- Dropdown Menu -->
                                    <div v-show="showWarehouseMenu" class="absolute left-0 top-full w-56 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50"
                                         style="margin-top: -2px; padding-top: 3px;">
                                        <div class="py-1">
