                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <template v-if="$page.props.auth.user">
                                ...
                                <div class="relative inline-flex items-center" @mouseenter="showWarehouseMenu = true" @mouseleave="showWarehouseMenu = false">
                                    <button type="button" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none" 
                                    ...
                                    <!-- Dropdown Menu -->
                                    <div v-show="showWarehouseMenu" class="absolute left-0 top-full mt-1 w-56 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50">
                                        <div class="py-1">
